			...
			<form action="{{ route('admin.products.store') }}" class="product-form" method="POST" enctype="multipart/form-data">
				...
				<div class="row">
					<div class="col-md-8">
						...
						<div class="card-widget">
							<div class="cw-header">
								<span class="name">{{ __('Product short description') }}</span>
							</div>
							<div class="cw-body">
								<div class="form-group">
					...
					<div class="col-md-4">
						<div class="card-widget">
							<div class="cw-header">
								<span class="name">{{ __('Publish') }}</span>
							</div>
							<div class="cw-body">
								<div class="form-group">
						...
						<div class="card-widget">
							<div class="cw-header">
								<span class="name">{{ __('Product categories') }}</span>
							</div>
							<div class="cw-body">
								<div class="form-group">
						...
						<div class="card-widget">
							<div class="cw-header">
								<span class="name">{{ __('Product tags') }}</span>
							</div>
							<div class="cw-body">
								<div class="form-group">
						...
						<div class="card-widget">
							<div class="cw-header">
								<span class="name">{{ __('Product image') }}</span>
							</div>
							<div class="cw-body">
								<div class="form-group">
						...
						<div class="card-widget">
							<div class="cw-header">
								<span class="name">{{ __('Product gallery') }}</span>
							</div>
							<div class="cw-body">
								<div class="form-group">
									<div class="custom-file">
