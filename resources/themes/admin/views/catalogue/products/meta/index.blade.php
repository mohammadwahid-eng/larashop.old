<div class="card-widget">
    <div class="cw-header">
        <span class="name">{{ __('Product meta') }}</span>
    </div>
    <div class="cw-body p-0">
        <div class="form-group d-flex gap-3 align-items-center m-0 p-3 border-bottom">
            ...
            <label class="custom-switch pl-0">
                <input type="checkbox" name="virtual" id="virtual" class="custom-switch-input" @if (old('virtual')) checked @endif>
                <span class="custom-switch-indicator"></span>
                <span class="custom-switch-description" data-toggle="tooltip" title="{{ __('Virtual products are intangible and are not shipped.') }}">{{ __('Virtual') }}</span>
            </label>
            <label class="custom-switch pl-0">
                <input type="checkbox" name="downloadable" id="downloadable" class="custom-switch-input" @if (old('downloadable')) checked @endif>
                <span class="custom-switch-indicator"></span>
                <span class="custom-switch-description" data-toggle="tooltip" title="{{ __('Downloadable products give access to a file upon purchase.') }}">{{ __('Downloadable') }}</span>
            </label>
        </div>
        <div class="d-flex">
