                ...
                <ul class="customer-links list-inline">
                    @guest
                        ...
                        @if (Route::has('customer.registration'))
                            <li><a href="{{ route('customer.registration') }}">{{ __('Create Account') }}</a></li>
                        @endif
                    @else
                        <li class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="{{ route('customer.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">{{ __('Logout') }}</a>
